...
class KeypadDefuse 
{
	...
	class controls 
	{
		...
		class Benter: RscButton
		{
			...
			offsetPressedY = 0.002;
			soundClick[] = {"",0,0};
			onMouseButtonDown = "closeDialog 0; nul = [CODE, CODEINPUT] execVM 'bomb\keypad_defuse\CodeCompare.sqf'";
		};
		...
		class KeypadImage: RscPicture
		{
			...
			h = 1.254 * safezoneH;
			text = "bomb\keypad_defuse\explosive.paa";
		};
		...
		class Bblue: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BLUE'] execVM 'bomb\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
		class Bwhite: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['WHITE'] execVM 'bomb\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
		class Byellow: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['YELLOW'] execVM 'bomb\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
		class Bgreen: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['GREEN'] execVM 'bomb\keypad_defuse\wireCompare.sqf'; closeDialog 0";
		};
	};
};
////////////////////////////////////////////////////////
